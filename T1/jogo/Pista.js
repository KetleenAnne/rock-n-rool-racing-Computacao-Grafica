...
const POSICAO_INICIAL_PISTA_1 = { x: 69, y: 0.3, z: 128 };
const POSICAO_INICIAL_PISTA_2 = { x: 27, y: 0.3, z: 136 };
...
export function criarPista1(scene) {
  ...
  try {
    ...
    segmentos.forEach(seg => {
      const mureta = criarSegmentoMureta(seg.posicoes, TAMANHO_BLOCO, seg.orientacao);
