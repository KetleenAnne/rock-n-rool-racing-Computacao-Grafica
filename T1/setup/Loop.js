...
import { verificarColisao } from "../jogo/Colisao.js";
...
export function startLoop(renderer, scene, camera, veiculo) {
  ...
  function render() {
    ...
    const colisao = verificarColisao(veiculo.position, muretas, 1.1); // voltar essa linha para 1.2 no teste de colisão
